...
import torch
import torchvision
from video_features.models._base.base_extractor import BaseExtractor
from video_features.models.i3d.i3d_src.i3d_net import I3D
from video_features.models.raft.extract_raft import DATASET_to_RAFT_CKPT_PATHS
from video_features.models.raft.raft_src.raft import RAFT, InputPadder
from video_features.models.transforms import (Clamp, PermuteAndUnsqueeze, PILToTensor,
                               ResizeImproved, ScaleTo1_1, TensorCenterCrop,
                               ToFloat, ToUInt8)
from video_features.utils.io import reencode_video_with_diff_fps
from video_features.utils.utils import dp_state_to_normal, show_predictions_on_dataset
...
class ExtractI3D(BaseExtractor):
    ...
    def load_model(self) -> Dict[str, torch.nn.Module]:
        ...
        i3d_weights_paths = {
            'rgb': './video_features/models/i3d/checkpoints/i3d_rgb.pt',
            'flow': './video_features/models/i3d/checkpoints/i3d_flow.pt',
        }
        name2module = {}
