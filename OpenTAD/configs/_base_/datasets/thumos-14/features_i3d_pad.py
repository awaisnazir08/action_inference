...
annotation_path = "../datafiles/sample2.json"
class_map = "../datafiles/category_idx.txt"
data_path = r"../code files/video_features/rally_features_i3d_stride_4"
block_list = "../datafiles/missing_files.txt"
